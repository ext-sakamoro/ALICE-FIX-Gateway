...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['1 FIX session', '1,000 messages/day', 'FIX 4.4 only', 'Community support'] },
  { name: 'Pro', price: '$99/mo', features: ['10 FIX sessions', '100K messages/day', 'FIX 4.2-5.0', 'Auto-failover', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited sessions', 'Dedicated endpoints', 'Custom FIX adapters', 'SLA guarantee', 'Dedicated support'] },
];
